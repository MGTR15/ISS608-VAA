...
p <- ggplot(data = df, aes(x = date, y= close)) +
  geom_line(color = "steel_blue") +
  geom_hline(yintercept = mean_close, color = "grey0", linetype = "dashed", size = 
0.5, alpha = 0.8) +
  geom_hline(yintercept = ucl, color= "red", linetype = "dotted", size = 0.5, alpha = 
0.8) +
  geom_hline(yintercept = lcl, color= "red", linetype = "dotted", size = 0.5, alpha = 
0.8) +
...
scale_color_manual(values = c ("Above UCL" = "red", "Below LCL" = "red", "withihn 
Limits" = "steelblue")) +
