...
# Part A: Visualize the careers of three artists. Compare and contrast their rise in popularity and influence.
Before comparing success between 2 singers and Sailor. We will be defining the remaining 2 singers by defining their popularity. Popularity will be defined by possible metrics:

- Number of songs performed

- Number of collaborations (songs with multiple artists)

- Mentions in notable field (top charts, award  winning)

- Number of songs influenced by their songs

### Convert to character format to match 
...
### Find out the most popular artists by giving them score and rank
...
### Log to to amplify small differences
...
## Compare 3 singers careers: Sailor, Kimberly and Ping Timeline. 
